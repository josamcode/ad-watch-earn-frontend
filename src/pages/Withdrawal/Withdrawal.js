  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all">
        ...
        <div className="p-6">
          <div className="space-y-4">
            ...
            <div className="flex justify-center mb-4">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-100 to-red-100 dark:from-orange-900/30 dark:to-red-900/30 rounded-full flex items-center justify-center">
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4 border border-orange-200 dark:border-orange-800">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-sm text-orange-800 dark:text-orange-200 font-medium">
                    فريق الموقع لن يطلب منك أبدًا أي رمز تحقق (OTP) أو أرقام سرية لإتمام السحب.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-4 border border-red-200 dark:border-red-800">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-sm text-red-800 dark:text-red-200 font-medium">
                    حماية بياناتك البنكية مسؤوليتك وحدك، وأي إفصاح عن هذه البيانات يعرضك للمخاطر المالية
                    دون أي مسؤولية على الموقع أو القائمين عليه.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mt-6">
              <p className="text-lg font-semibold text-gray-900 dark:text-white">
                هل تريد المتابعة مع طلب السحب؟
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                بالمتابعة، أنت تؤكد فهمك وموافقتك على التنبيهات الأمنية أعلاه
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Modal Footer */}
        <div className="flex items-center gap-3 space-x-3 p-6 border-t border-gray-200 dark:border-gray-700">
          <Button
            onClick={onClose}
            variant="outline"
          ...
          <Button
            onClick={onConfirm}
            loading={loading}
            className="flex-1 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800"
          >
            نعم، أريد المتابعة
          </Button>
        </div>
          ...
          {pendingWithdrawal ? (
            ...
            <Card className="p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  disabled={!user.balance || user.balance <= 0 || loading}
                  fullWidth
                  size="lg"
                >
                  تقديم طلب السحب
